...
E2E_USERS = (
    ...
    {
        "app": "DOCUCORE",
        "email_env": "AUTH_E2E_DOCUCORE_USER",
        "password_env": "AUTH_E2E_DOCUCORE_PASSWORD",
        "default_email": "auth-e2e-docucore-user@example.local",
        "role": "CUSTOMER",
        "first_name": "E2E",
        "last_name": "DocuCore User",
        "staff": False,
        "superuser": False,
    },
    {
        "app": "FISCORA",
        "email_env": "AUTH_E2E_FISCORA_USER",
        "password_env": "AUTH_E2E_FISCORA_PASSWORD",
        "default_email": "auth-e2e-fiscora-user@example.local",
        "role": "CUSTOMER",
        "first_name": "E2E",
        "last_name": "Fiscora User",
        "staff": False,
        "superuser": False,
    },
    {
        "app": "IMAGRAFITY",
        "email_env": "AUTH_E2E_IMAGRAFITY_USER",
        "password_env": "AUTH_E2E_IMAGRAFITY_PASSWORD",
        "default_email": "auth-e2e-imagrafity-user@example.local",
        "role": "CUSTOMER",
        "first_name": "E2E",
        "last_name": "Imagrafity User",
        "staff": False,
        "superuser": False,
    },
)
